...
public class PageNavigation {
	...
	public void setMylottoNavigator() {
		...
		if (this.isNowFirst()) {
			tmpNavigator.append("  <td><font color='#999999'>이전</font></td>\n");
		} else {
			int prePage = (pageNo - 1) / pageSize * pageSize;
			tmpNavigator.append("  <td><a href=\"javascript:listArticle('" + bcode + "', '" + prePage + "');\">이전</a></td>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			if (pageNo == i) {
				tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><b>" + i + "</b></td>\n");
			} else {
		...
		if (this.isNowEnd()) {
			tmpNavigator.append("   <td><font color='#999999'>다음</font></td>\n");
		} else {
			int nextPage = (pageNo - 1) / pageSize * pageSize + pageSize + 1;//(pageNo + pageSize - 1) / pageSize * pageSize + 1
			tmpNavigator.append("   <td><a href=\"javascript:listArticle('" + bcode + "', '" + nextPage + "', '" + key + "', '" + word + "');\">다음</a></td>\n");
		}
		tmpNavigator.append(" </tr>\n");
		tmpNavigator.append("</table>\n");
